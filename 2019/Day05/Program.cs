...
static class Ex
{
    internal static void SetValue(this int[] program, int value, (int, Mode) parameter)
    {
        (var index, var mode) = parameter;
        program[index] = value;
    }
    internal static int GetValue(this int[] program, (int, Mode) parameter)
    {
        (var index, var mode) = parameter;
        return mode switch
        {
    ...
    internal static IEnumerable<int> GetValues(this int[] program, IEnumerable<(int, Mode)> parameters)
    {
