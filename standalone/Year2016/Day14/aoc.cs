...
int Write(int i, char c, int j)
{
    Console.WriteLine($"{i} - {c} - {j}");
    return i;
}

string GetHash(Dictionary<int, string> hashes, string salt, int seed, int repeat = 0)
{
...
char? Find3(Dictionary<int, string> hashes, string salt, int seed, int repeat = 0)
{
...
bool IsValid2(Dictionary<int, string> hashes, string salt, int seed, char c, int repeat = 0)
{
