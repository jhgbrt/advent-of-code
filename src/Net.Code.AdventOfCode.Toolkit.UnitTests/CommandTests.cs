...
public class CommandTests
{
    ...
    private IPuzzleManager CreatePuzzleManager()
    {
        ...
        foreach (var key in AoCLogic.Puzzles())
        {
            var puzzle = Puzzle.Create(key, "input", string.Empty, new Answer("answer1", ""), string.Empty);
...
public class PuzzleTests
{
    ...
    {
        var puzzle = new Puzzle(new(2015, 1), "input", string.Empty, new Answer("a", "b"), Status.Completed, string.Empty);
    ...
    {
        var puzzle = Puzzle.Create(new(2015, 1), "input", string.Empty, Answer.Empty, string.Empty);
    ...
    {
        var puzzle = Puzzle.Create(new(2015, 1), "input", string.Empty, new Answer("part1", string.Empty), string.Empty);
        var answer = puzzle.CreateAnswer("answer");
