...
namespace Net.Code.AdventOfCode.Toolkit.Migrations
{
    ...
    [Migration("20251209201603_Example")]
            ...
            modelBuilder.Entity("Net.Code.AdventOfCode.Toolkit.Core.DayResult", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Part1", "Net.Code.AdventOfCode.Toolkit.Core.DayResult.Part1#Result", b1 =>
                        {
                            b1.IsRequired();
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Part2", "Net.Code.AdventOfCode.Toolkit.Core.DayResult.Part2#Result", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Net.Code.AdventOfCode.Toolkit.Core.Puzzle", b =>
                {
                    ...
                    b.ComplexProperty(typeof(Dictionary<string, object>), "Answer", "Net.Code.AdventOfCode.Toolkit.Core.Puzzle.Answer#Answer", b1 =>
                        {
                            b1.IsRequired();
