...
public readonly record struct DotColor(byte R, byte G, byte B, byte A = 255)
{
    public override string ToString() => $"[DotColor, R:{R}, G:{G}, B:{B}, A:{A}]";

    public string ToHexString() => A == 255 ? $"#{R:X2}{G:X2}{B:X2}" : $"#{R:X2}{G:X2}{B:X2}{A:X2}";
